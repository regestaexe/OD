        ...
        var sbBox = new Ext.BoxComponent({
            ...
            listeners:{
        				'afterrender':function(){        	 					
	        					if(top.Application.user.dipartimentoExt!=''){
	        						console.debug($("#ux-taskbar-start"));
	        						$("#ux-taskbar-start").prepend('<span style="float:right;margin-top:6px;margin-right:5px;color:#ffffff;font-weight:bold;">'+top.Application.user.dipartimentoExt+'</span>');
								}
        				}
        	}
        });
